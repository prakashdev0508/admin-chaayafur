...
| Status | Description |
|--------|-------------|
| `PENDING` | Awaiting Razorpay payment (checkout or shareable manual-order link) or offline collection (manual mark-paid) |
...
| `MANUAL` | Staff `POST /admin/orders` — shareable Razorpay link and/or cash / UPI / bank transfer via mark-paid |
