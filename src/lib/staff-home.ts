...
export const STAFF_HOME_CANDIDATES: StaffHomeCandidate[] = [
  ...
  { path: "/wallet-withdrawals", permission: PERMISSIONS.VIEW_WALLETS },
  { path: "/coupons", permission: PERMISSIONS.VIEW_COUPONS },
  { path: "/referrals", permission: PERMISSIONS.VIEW_REFERRALS },
  { path: "/customers", permission: PERMISSIONS.VIEW_CUSTOMERS },
  { path: "/carts", permission: PERMISSIONS.VIEW_CUSTOMERS },
  { path: "/reviews", permission: PERMISSIONS.VIEW_REVIEWS },
  { path: "/contact", permission: PERMISSIONS.VIEW_SETTINGS },
  { path: "/careers", permission: PERMISSIONS.VIEW_CAREERS },
...
const ROUTE_PERMISSIONS: Record<string, Permission | null> = {
  ...
  "/wallet-withdrawals": PERMISSIONS.VIEW_WALLETS,
  "/coupons": PERMISSIONS.VIEW_COUPONS,
  "/referrals": PERMISSIONS.VIEW_REFERRALS,
  "/customers": PERMISSIONS.VIEW_CUSTOMERS,
  "/carts": PERMISSIONS.VIEW_CUSTOMERS,
  "/reviews": PERMISSIONS.VIEW_REVIEWS,
  "/contact": PERMISSIONS.VIEW_SETTINGS,
  "/careers": PERMISSIONS.VIEW_CAREERS,
